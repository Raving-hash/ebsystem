package com.raving.ebsystem.common.node;
...
public class MenuNode implements Comparable {
    ...
    public static List<MenuNode> buildTitle(List<MenuNode> nodes) {
        ...
        EbsystemProperties ravingProperties = SpringContextHolder.getBean(EbsystemProperties.class);
        if (!ravingProperties.getSwaggerOpen()) {
