...
import com.raving.ebsystem.modular.system.factory.UserFactory;
import com.raving.ebsystem.modular.system.transfer.UserDto;
import com.raving.ebsystem.modular.system.warpper.UserWarpper;
...
public class UserMgrController extends BaseController {
    ...
    @Resource
    private EbsystemProperties ebsystemProperties;
    ...
    @Permission
    @ResponseBody
    public Object list(@RequestParam(required = false, name = "selectName") String name, @RequestParam(required = false) String beginTime, @RequestParam(required = false) String endTime, @RequestParam(required = false) Integer deptid) {
        Integer userId = ShiroKit.getUser().getId();
        User user = userMapper.selectByPrimaryKey(userId);
    ...
    public String upload(@RequestPart("file") MultipartFile picture) {
        ...
        try {
            String fileSavePath = ebsystemProperties.getFileUploadPath();
